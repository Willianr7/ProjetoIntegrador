...
function Sobrenos() {
  ...
  <Grid item xs={6} >
                  ...
                  <img src="https://cdn.discordapp.com/attachments/1047476710578331680/1053266380876697610/IMG-20210917-WA0159-removebg-preview.png" alt="" width="250px" height="250px" />
                  <img src="https://media.discordapp.net/attachments/1050176198895997051/1053328935431176332/FB_IMG_1670456969090-removebg-preview.png" alt="" width="170px" height="200px" />
              </Grid>
               </Grid>
              </>
  )
